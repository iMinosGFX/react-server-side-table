...
var Table = function (_a) {
    var columns = _a.columns, data = _a.data, renderRowSubComponent = _a.renderRowSubComponent, hiddenColumns = _a.hiddenColumns;
    var _b = reactTable_1({
        columns: columns,
        data: data,
        initialState: {
    ...
    }, reactTable_3), getTableProps = _b.getTableProps, getTableBodyProps = _b.getTableBodyProps, headerGroups = _b.headerGroups, prepareRow = _b.prepareRow, rows = _b.rows, visibleColumns = _b.visibleColumns, setHiddenColumns = _b.setHiddenColumns;
    React.useEffect(function () {
        setHiddenColumns(hiddenColumns);
    }, [hiddenColumns]);
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement("table", __assign({}, getTableProps(), { className: "table no-border" }),
            React__default.createElement("thead", { className: "no-border" }, headerGroups.map(function (headerGroup) { return (React__default.createElement("tr", __assign({}, headerGroup.getHeaderGroupProps()), headerGroup.headers.map(function (column) {
                return (React__default.createElement("th", __assign({}, column.getHeaderProps()),
                    React__default.createElement("span", null, column.render('Header'))));
            }))); })),
            React__default.createElement("tbody", __assign({}, getTableBodyProps(), { className: "no-border" }), rows.map(function (row, i) {
                prepareRow(row);
                return (React__default.createElement(React__default.Fragment, { key: row.getRowProps().key },
                    React__default.createElement("tr", __assign({}, row.getRowProps()), row.cells.map(function (cell) {
                        return React__default.createElement("td", __assign({}, cell.getCellProps()), cell.render('Cell'));
                    })),
...
var FilterContainer = styled('div')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    width: 100%;\n    box-sizing: border-box;\n    padding: ", ";\n    margin:  ", ";\n    .title{\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        color: #888;\n        cursor: pointer;\n        label {\n            font-size: 14px;\n        }\n        .chevron{\n            padding-right: 5px;\n        }\n    }\n    .inputs{\n        display: ", ";\n        input[type='text'], input[type='date'], input[type=\"number\"]{\n            background: ", ";\n            height: ", ";\n            line-height: ", ";\n            border: ", ";\n            width: ", ";\n            padding-left: 5px;\n            float: right;\n            margin-bottom: ", ";\n            color: #435F71 !important;\n        }\n\n        .filterSelectChoice__control{\n            border: none;\n            margin-bottom: ", ";\n            width: ", ";\n            background: ", ";\n            border-radius: 2px 0 0 2px;\n        }\n        .filterSelectChoice__control--is-focused{\n            border:none;\n            box-shadow: none;\n        }\n        .filterSelectChoice__indicator-separator{\n            display: none;\n        }\n        .filterSelectChoice__single-value{\n            color: ", ";\n        }\n        .filterSelectChoice__input{\n            input{\n                color: ", ";\n                height: 1.2rem !important;\n                font-size: 15px !important;\n            }\n        }\n    }\n"], ["\n    width: 100%;\n    box-sizing: border-box;\n    padding: ", ";\n    margin:  ", ";\n    .title{\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        color: #888;\n        cursor: pointer;\n        label {\n            font-size: 14px;\n        }\n        .chevron{\n            padding-right: 5px;\n        }\n    }\n    .inputs{\n        display: ", ";\n        input[type='text'], input[type='date'], input[type=\"number\"]{\n            background: ", ";\n            height: ", ";\n            line-height: ", ";\n            border: ", ";\n            width: ", ";\n            padding-left: 5px;\n            float: right;\n            margin-bottom: ", ";\n            color: #435F71 !important;\n        }\n\n        .filterSelectChoice__control{\n            border: none;\n            margin-bottom: ", ";\n            width: ", ";\n            background: ", ";\n            border-radius: 2px 0 0 2px;\n        }\n        .filterSelectChoice__control--is-focused{\n            border:none;\n            box-shadow: none;\n        }\n        .filterSelectChoice__indicator-separator{\n            display: none;\n        }\n        .filterSelectChoice__single-value{\n            color: ", ";\n        }\n        .filterSelectChoice__input{\n            input{\n                color: ", ";\n                height: 1.2rem !important;\n                font-size: 15px !important;\n            }\n        }\n    }\n"])), function (props) { return props.filtersPosition === "list" ? "8px 5px" : "0"; }, function (props) { return props.filtersPosition === "list" ? "10px 0" : "0 0 10px 0"; }, function (props) { return props.filtersPosition === "list" ? "block" : "flex"; }, function (props) { return props.darkMode ? "#272d3a" : "#ECECEC"; }, function (props) { return props.filtersPosition === "list" ? "35px" : "38px"; }, function (props) { return props.filtersPosition === "list" ? "35px" : "38px"; }, function (props) { return props.filtersPosition === "list" ? "1px solid #E0E0E0" : "initial"; }, function (props) { return props.filtersPosition === "list" ? "70%" : "100%"; }, function (props) { return props.filtersPosition === "list" ? "10px" : "initial"; }, function (props) { return props.filtersPosition === "list" ? "10px" : "initial"; }, function (props) { return props.filtersPosition === "field" ? "155px" : "initial"; }, function (props) { return props.darkMode ? "#141b24" : "#e3e3e3"; }, function (props) { return props.darkMode ? "#bccde0" : "#initial"; }, function (props) { return props.darkMode ? "#bccde0" : "#initial"; });
var CheckContainer = styled('div')(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    max-height: 200px;\n    overflow: auto;\n    position: relative;\n    z-index: 99;\n    background:", ";\n    box-shadow: ", ";\n    .check-group{\n        label{\n            color: #435F71 !important;\n            &:after{\n                top: 2px;\n            }\n        }\n    }\n"], ["\n    max-height: 200px;\n    overflow: auto;\n    position: relative;\n    z-index: 99;\n    background:", ";\n    box-shadow: ", ";\n    .check-group{\n        label{\n            color: #435F71 !important;\n            &:after{\n                top: 2px;\n            }\n        }\n    }\n"])), function (props) { return props.filtersPosition === "field" ? props.darkMode ? "#272d3a" : "#ECECEC" : "initial"; }, function (props) { return props.filtersPosition === "field" ? "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)" : "initial"; });
    ...
    return (React__default.createElement(FilterContainer, { filtersPosition: filtersPosition, darkMode: darkMode },
        React__default.createElement("div", { className: "inputs" },
            props.filterParsedType === "rsql" ?
                ...
                :
                    filtersPosition === "list" && React__default.createElement("span", { style: { lineHeight: "2.4rem", color: "#435F71" } }, (_k = (_j = translationsProps === null || translationsProps === void 0 ? void 0 : translationsProps.filtersViewer) === null || _j === void 0 ? void 0 : _j.contain) !== null && _k !== void 0 ? _k : translations.filtersViewer.contain),
...
var CheckboxFilter = function (props) {
    ...
    if (filtersPosition === "field") {
        return (React__default.createElement(FieldContainer, { ref: node, onClick: function () { setOpen(true); }, darkMode: darkMode },
            ...
            open &&
                React__default.createElement(CheckContainer, { filtersPosition: filtersPosition, darkMode: darkMode }, props.filter.checkboxValues.map(function (check, i) { return (React__default.createElement("div", { className: "check-group", style: { paddingTop: 10 }, key: i },
...
var BooleanRadioFilter = function (props) {
    ...
    if (filtersPosition === "field") {
        return (React__default.createElement(FieldContainer, { ref: node, onClick: function () { setOpen(true); }, darkMode: darkMode },
            ...
            open &&
                React__default.createElement(CheckContainer, { filtersPosition: filtersPosition, darkMode: darkMode }, filtersState.filtersState[props.filter.name]["main"]["value"].flatMap(function (radio, i) {
                    var _a, _b, _c;
...
var ItemFilter = function (props) {
    ...
    if (filtersPosition === "field") {
        return (React__default.createElement(React__default.Fragment, null,
            React__default.createElement(FieldItem, { widthPercentage: props.filter.widthPercentage, className: "SST_field_filter_item" },
            ...
            filtersState.filtersState[props.filter.name].optionals.map(function (optional, i) { return (React__default.createElement(FieldItem, { widthPercentage: props.filter.widthPercentage, key: i, className: "SST_field_filter_item SST_field_filter_optional_item" },
                React__default.createElement("label", null,
                    props.filter.label,
                    " ",
        ...
        return (React__default.createElement(ListItem, { ref: node, onClick: function () { setOpen(true); }, className: "SST_list_filter_item" },
...
var FiltersInteract = function (props) {
    ...
    return (React__default.createElement(FiltersContext.Consumer, null, function (filterContext) {
        ...
        return (filtersPosition === "list" ?
            React__default.createElement(ListContainer$1, { className: "SST_list_filters_container" },
            ...
            :
                React__default.createElement(SectionFilters, { className: "SST_field_filters_container" },
                    ...
                    isFilterOpen &&
                        React__default.createElement(React__default.Fragment, null,
                            React__default.createElement(FieldContainer$1, { className: "SST_field_filters" }, filters.map(function (filter) { return (React__default.createElement(ItemFilter, { key: filter.name, filter: filter, filterParsedType: props.filterParsedType, translationsProps: translationsProps, filtersPosition: filtersPosition, darkMode: darkMode })); })),
...
var TableContainer = styled("div")(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n    padding-top: 10px;\n    margin: 0 5px;\n    .extender{\n        position: absolute; \n        top: -25px;\n        left:0;\n        width: 40px;\n        height: 25px;\n        line-height: 25px;\n        font-size: 18px;\n        text-align: center; \n        background-color: #E0E0E0;\n        color: #606060;\n        border-radius: 5px 5px 0 0;\n        cursor: pointer;\n    }\n    .selectContainer{\n        display: inline-block !important;\n        width: 250px;\n        text-align: left;\n        padding-right: 20px;\n        .ServerSideTableFilterSelect__control{\n            background: ", ";\n            border:1px solid ", ";\n            .ServerSideTableFilterSelect__placeholder{\n                color: ", ";\n            }\n        }\n        .ServerSideTableFilterSelect__menu{\n            background: ", ";\n            color: ", ";\n        }\n        .ServerSideTableFilterSelect__input{\n            input{\n                height: 1rem !important;\n            }\n\n        }   \n    } \n    .SST_HEADER{\n        padding: .4rem;\n        width: 100%;\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        padding-right: 10px;\n        .SST_actions_buttons{\n            display: flex;\n            align-items: center;\n            .SST_optional_button{\n                margin-left: 10px;\n                background: none;\n                border: none;\n                color: ", ";\n                span{\n                    display: flex;\n                    align-items: center;\n                    font-size: 1rem;\n                    svg{\n                        margin-right: 5px;\n                    }\n                }\n            }\n        }\n    }\n    @media only screen and (max-width: 540px){\n        .SST_HEADER{\n            display: contents;\n            button{\n                float: right;\n                margin-bottom: 10px;\n            }\n            .table-actions-container{\n                clear: both;\n                justify-content: space-between;\n                margin-bottom: 10px;\n            }\n        }\n    }\n"], ["\n    padding-top: 10px;\n    margin: 0 5px;\n    .extender{\n        position: absolute; \n        top: -25px;\n        left:0;\n        width: 40px;\n        height: 25px;\n        line-height: 25px;\n        font-size: 18px;\n        text-align: center; \n        background-color: #E0E0E0;\n        color: #606060;\n        border-radius: 5px 5px 0 0;\n        cursor: pointer;\n    }\n    .selectContainer{\n        display: inline-block !important;\n        width: 250px;\n        text-align: left;\n        padding-right: 20px;\n        .ServerSideTableFilterSelect__control{\n            background: ", ";\n            border:1px solid ", ";\n            .ServerSideTableFilterSelect__placeholder{\n                color: ", ";\n            }\n        }\n        .ServerSideTableFilterSelect__menu{\n            background: ", ";\n            color: ", ";\n        }\n        .ServerSideTableFilterSelect__input{\n            input{\n                height: 1rem !important;\n            }\n\n        }   \n    } \n    .SST_HEADER{\n        padding: .4rem;\n        width: 100%;\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        padding-right: 10px;\n        .SST_actions_buttons{\n            display: flex;\n            align-items: center;\n            .SST_optional_button{\n                margin-left: 10px;\n                background: none;\n                border: none;\n                color: ", ";\n                span{\n                    display: flex;\n                    align-items: center;\n                    font-size: 1rem;\n                    svg{\n                        margin-right: 5px;\n                    }\n                }\n            }\n        }\n    }\n    @media only screen and (max-width: 540px){\n        .SST_HEADER{\n            display: contents;\n            button{\n                float: right;\n                margin-bottom: 10px;\n            }\n            .table-actions-container{\n                clear: both;\n                justify-content: space-between;\n                margin-bottom: 10px;\n            }\n        }\n    }\n"])), function (props) { return props.darkMode ? "#2a3c4e" : "#fff"; }, function (props) { return props.darkMode ? "#272d3a" : "#E0E0E0"; }, function (props) { return props.darkMode ? "#bccde0" : "#2a3c4e"; }, function (props) { return props.darkMode ? "#2a3c4e" : "#fff;"; }, function (props) { return props.darkMode ? "#bccde0" : "#435F71"; }, function (props) { return props.darkMode ? "#bccde0" : "#2a3c4e"; });
...
var ServerSideTable = React.forwardRef(function (props, ref) {
    ...
    var _h = React.useState(!!props.tableId ? getTableFilters(props.tableId) : {}), submitFiltersState = _h[0], setSubmitFilterState = _h[1];
    ...
    var _p = React.useState(getFilterType()), filterType = _p[0], setFilterType = _p[1];
    var _q = React.useState([]), hiddenColumns = _q[0], setHiddenColumns = _q[1];
    var Option = Select.components.Option;
    var _r = React.useState(null), parsedFilters = _r[0], setParsedFilters = _r[1];
    ...
    React.useEffect(function () {
        if (isInitialMount.current)
            ...
            props.onDataChange({ offset: offset, perPage: perPage, filters: parsedFilters, sorter: sorterValue === null || sorterValue === void 0 ? void 0 : sorterValue.value });
        }
    }, [offset, perPage]);
    React.useEffect(function () {
        if (isInitialMount.current)
                    ...
                    return ([
                        {
                            ...
                            label: filter.label,
                            icon: React__default.createElement(fa.FaAngleUp, { style: { paddingLeft: 5 }, color: "#57606f" })
                        },
                        {
                            value: filter.value + ",desc",
                            label: filter.label,
                            icon: React__default.createElement(fa.FaAngleDown, { style: { paddingLeft: 5 }, color: "#57606f" }),
                        }
                    ]);
                }));
        }
                ...
                !props.withoutHeader &&
                    React__default.createElement("div", { className: "SST_HEADER" },
                        React__default.createElement("div", { className: "SST_actions_buttons" },
                            props.showAddBtn &&
                                React__default.createElement("button", { className: "btn bg-primary sst_main_button", onClick: props.onAddClick }, (_a = translationsProps === null || translationsProps === void 0 ? void 0 : translationsProps.add) !== null && _a !== void 0 ? _a : translations.add),
                            props.showOptionalBtn && !!props.optionalIconContent && !!props.onOptionalBtnClick &&
                                React__default.createElement("button", { className: "SST_optional_button", onClick: props.onOptionalBtnClick },
                                    React__default.createElement("span", null,
                                        props.optionalIconContent.icon,
                                        " ",
                                        props.optionalIconContent.text))),
                ...
                props.data &&
                    React__default.createElement(React__default.Fragment, null,
                        props.isFilter && !!props.filtersList && props.filtersList.length > 0 &&
                            React__default.createElement(React__default.Fragment, null,
                                React__default.createElement(FiltersContainer, { darkMode: props.darkMode, filterPosition: filterType, className: ((_c = props.filtersContainerClassName) !== null && _c !== void 0 ? _c : "") + " SST_filters_container" },
